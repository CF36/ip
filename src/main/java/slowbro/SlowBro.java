...
public class SlowBro {
    ...
    public static void main(String[] args) {
        ...
        int taskCount = loadedTasks.length;
    ...
    private static int handleCommand(String input, Task[] tasks, int taskCount, Storage storage) {
        try {
    ...
    private static void markTask(String input, Task[] tasks, int taskCount, Storage storage) {
